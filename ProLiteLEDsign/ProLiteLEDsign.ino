 ...
 * www.robotic.icu/favorites.php?uid=123456789
 * 
 * This is the bot under test:
 * www.robotic.icu/robot.php?id=849081125
 * 
 * This is the bot json code:
 * robotic.icu/robotid.php?id=849081125
 * 
 * 
 */
const char* host = "www.robotic.icu";
const char* streamId = "xxxxxxxxx";
const char* DeviceID = "849081125";// My Home
/* 
849081125 477383611 
